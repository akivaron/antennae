...
const page2Data = [
  ...
  },
  {
    ...
    slogan:
      'Materi pembelajaran pada bahan ajar Programmed Learning yaitu mata pelajaran Pemrograman Dasar. Pada bahan ajar ini terdapat 2 versi materi yaitu materi dalam bentuk tulisan yang menggunakan metode Programmed Learning dan materi dalam bentuk video. Tujuannya mencantumkan 2 versi materi agar siswa yang mempunyai sifat belajar visual atau audio visual dapat tetap memahami materi.',
  },
  {
    img: 'https://gw.alipayobjects.com/zos/rmsportal/GobRAKexhfTSJdLFzDFY.svg',
    name: 'Waktu Belajar',
    slogan:
      'Pembelajaran pada bahan ajar ini dapat dilakukan di waktu pembelajaran disekolah atau dilakukan diluar sekolah, sehingga siswa dapat mempelajari materi kembali jika belum memahaminya.',
  },
  {
    img: 'https://gw.alipayobjects.com/zos/rmsportal/slVtnOCcgeAcLEPwtewY.svg',
    name: 'Cara Belajar Di Bahan Ajar Programmed Learning',
    slogan:
      'Siswa yang sudah maupun belum terdaftar dapat mempelajari materi video untuk gambaran umum dari materi. Khusus siswa yang sudah terdaftar dapat mempelajari materi tulis dengan metode Programmed Learning, dimana materi tersebut terbagi menjadi beberapa bagian. Tiap bagian dari materi tersebut terdapat evaluasi berbasis tantangan yang harus dikerjakan oleh siswa agar siswa lebih memahami materi. Lebih jelasnya bias simak pada Petunjuk Penggunaan.',
  },
];
...
export default function HomeSection2({ isMobile }) {
  const componentButton = '';
  const children = page2Data.map((item, i) => {
    if (!isMobile && !i) {
      return null;
    }
    const content = isMobile && !i ? componentButton : [<p key="p">{item.slogan}</p>];
    return (
        ...
        <div>
          ...
          <ScrollOverPack component={Row} className="page2-content" playScale="0.4">
            <QueueAnim
              ...
              leaveReverse
            >
              <h3 key="h1">Bahan Ajar Programmed Learning</h3>
              <p key="p">
                Metode atau cara penyampaian bahan ajar oleh guru memberikan dampak kepada pemahaman
                siswa terhadap materi. Salah satu prinsip umum tentang mengajar ialah pengetahuan
                dan keterampilan yang diajarkan harus bersifat praktis (Amiruddin, 2016:11).
              </p>
              <p>
                Salah satu metode pembelajaran yang praktis yaitu dengan menggunakan metode
                pembelajaran terprogram (programmed learning). Metode pembelajaran terprogram
                menyampaikan materi dengan memberikan batasan atau tidak bertele-tele, sehingga
                dapat memberikan pemahaman terhadap siswa.
              </p>
              <p>
                Kegiatan pembelajaran membutuhkan evaluasi untuk mengukur pengetahuan siswa.
                Evaluasi pembelajaran berbasis tantangan dapat digunakan dalam pembelajaran dengan
                tujuan untuk memotivasi siswa dalam belajar. Tantangan pada evaluasi mata pelajaran
                Pemrograman Dasar berupa permasalahan yang ada di dunia nyata. Adanya masalah yang
                menjadi suatu tantangan yang harus dipecahkan akan meningkatkan kemampuan berpikir
                logis.
              </p>
              <p>
                Bahan ajar ini berbasis website dan terhubung dengan internet, sehingga bahan ajar
                ini dapat diakses oleh siswa dirumah untuk belajar sebagai bahan ajar pendamping
                siswa pada mata pelajaran Pemrograman Dasar.
              </p>
              <p>
                Bahan ajar programmed learning dikembangkan oleh Hartanti Iriyani Mahasiswa S1
                Pendidikan Teknik Informatika Universitas Negeri Malang untuk memenuhi mata kuliah
                Skripsi.
              </p>
              {componentButton}
            </QueueAnim>
