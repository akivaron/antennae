...
const page3Data = [
  {
    title: 'Meningkatkan Pemahaman Siswa',
    content:
      'Pada bahan ajar ini materi menggunakan metode Programmed Learning, dimana materinya dibagi menjadi beberapa bagian dalam bentuk frame dan materi akan diulang sampai siswa benar-benar memahami mata pelajaran Pemrograman Dasar.',
    img: 'https://gw.alipayobjects.com/zos/rmsportal/qggKjIGNFlVmMpwDUXPU.svg',
  },
  {
    title: 'Memotivasi Belajar Siswa',
    content:
      'Pada bahan ajar ini terdapat 2 versi materi yaitu materi tulis dan video. Hal ini dapat membantu pemahaman siswa terhadap materi serta memotivasi siswa dalam belajar mata pelajaran Pemrograman Dasar.',
    img: 'https://gw.alipayobjects.com/zos/rmsportal/dgjVqwkJvptQEtlfctvk.svg',
  },
  {
    title: 'Meningkatkan Logical Thinking Skill Siswa',
    content:
      'Pada bahan ajar ini terdapat evaluasi berbasis tantangan setelah siswa mempelajari materi pada setiap frame. Tantangan pada evaluasi mata pelajaran Pemrograman Dasar berupa permasalahan yang ada di dunia nyata. Adanya masalah yang menjadi suatu tantangan yang harus dipecahkan akan meningkatkan kemampuan berpikir logis.',
